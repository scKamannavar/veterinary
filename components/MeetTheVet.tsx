          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center relative z-10">
            ...
            <div className="w-full lg:w-1/3 flex justify-center">
              <div className="relative">
                ...
                <img
                  src="https://plus.unsplash.com/premium_photo-1677165653246-d727f5d8e1fc?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Dr. Sarah"
                ...
                <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg transform rotate-6">
                  <p className="font-extrabold text-brand-500 text-2xl">
                    Dr. Sarah
                  </p>
            ...
            <div className="w-full lg:w-2/3 lg:pl-10">
              ...
              <p className="text-xl text-slate-700 mb-8 font-medium leading-relaxed">
                "I don't just treat pets; I treat them like my own little
                furballs. My goal is to make tails wag and motors purr, even
                during a check-up!"
              </p>

              <div className="space-y-4 mb-8">
                <p className="text-slate-600">
                  Dr. Sarah Jenkins isn't your average vet. With a pocket full
                  of treats and a heart full of love, she's been caring for
                  Barktown's pets for over 15 years. She specializes in tummy
                  rubs, ear scratches, and advanced veterinary medicine (in that
                  order).
                </p>
              </div>
