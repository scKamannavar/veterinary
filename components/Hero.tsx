  ...
  return (
    <section className="relative pt-32 pb-24 overflow-hidden bg-paw-cream">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-7xl pointer-events-none opacity-40">
        <div className="absolute top-10 left-10 text-6xl text-brand-100/50 rotate-12 font-serif italic">
          &
        </div>
        <div className="absolute bottom-20 right-20 text-8xl text-brand-100/50 -rotate-12 font-serif italic">
          Care
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1 animate-fade-in-up">
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-black text-slate-900 leading-[0.9] mb-8 tracking-tight font-serif">
              Modern <br />
              <span className="font-light italic text-brand-600 pr-4">
                Veterinary
              </span>{" "}
              <br />
              Medicine.
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-lg mx-auto lg:mx-0 font-medium font-sans">
              Experience a new standard of pet care. Where cutting-edge medicine
              meets the comfort of home for your best friend.
            </p>
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
              <Button
                size="lg"
                className="shadow-xl shadow-brand-500/20 rounded-full px-10"
                onClick={() =>
                  document
              ...
              <Button
                variant="white"
                size="lg"
                className="border-2 border-slate-100 text-slate-600 hover:text-brand-600 hover:border-brand-200 rounded-full px-10"
                onClick={() =>
                  document
          ...
          <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end">
            ...
            <div className="relative w-full max-w-md mx-auto lg:mr-0 group">
              ...
              <div className="relative z-10 rounded-t-[15rem] rounded-b-[3rem] overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] border-[8px] border-white h-[550px] md:h-[650px] transition-all duration-700 group-hover:shadow-[0_40px_80px_-15px_rgba(13,148,136,0.2)]">
                <img
                  src="https://images.unsplash.com/photo-1563460716037-460a3ad24ba9?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              ...
              <div className="absolute bottom-12 -left-4 md:-left-12 z-20 bg-white/80 backdrop-blur-xl p-5 rounded-2xl shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] border border-white/50 max-w-[16rem] animate-float hidden sm:block">
                ...
                <p className="text-slate-700 font-serif italic mb-3 text-sm leading-relaxed">
                  "The most beautiful clinic I've ever seen. They truly care
                  about every detail."
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-brand-500 uppercase font-bold tracking-wider">
                      Verified Client
                    </p>
                  </div>
                </div>
              ...
              <div
                className="absolute -bottom-10 -left-10 w-64 h-64 bg-amber-200 rounded-full blur-3xl -z-10 opacity-40 animate-pulse-slow"
